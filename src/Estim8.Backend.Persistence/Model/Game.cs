...
namespace Estim8.Backend.Persistence.Model
{
    ...
    {
        [ProtoMember(1)] public string PublicId { get; set; }
        [ProtoMember(2)] public Guid CardSetId { get; set; }
        [ProtoMember(3)] public DateTimeOffset CreatedTimestamp { get; set; }
        [ProtoMember(4)] public DateTimeOffset StartedTimestamp { get; set; }
