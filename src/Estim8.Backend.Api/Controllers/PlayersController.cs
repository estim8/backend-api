...
namespace Estim8.Backend.Api.Controllers
{
    ...
    public class PlayersController : ApiControllerBase
    {
        ...
        public async Task<ActionResult<AddPlayerToGameResponse>> AddPlayer(Guid gameId, AddPlayerToGameRequest request)
        {
            ...
            await _gameHub.Clients.Groups(gameId.ToString()).PlayerAddedToGame(new PlayerMessage{GameId = gameId, PlayerId = playerId, PlayerName = request.PlayerName, Gravatar = request.Gravatar});
